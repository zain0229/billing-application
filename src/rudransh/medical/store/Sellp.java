            ...
            if(e.getSource()==b2)
         {
            ...
            if(e.getSource()==b5)
            {
                ...
                ResultSet rs=ps.executeQuery();
                 ...
                 JOptionPane.showMessageDialog(this,"TOTAL AMOUNT IS='"+t6.getText()+"'");
            ...
            try {
                PdfWriter.getInstance(doc,new FileOutputStream(path+"PDF FILE.pdf"));
                
                doc.open();
                
                FT.addCell("BID");
                FT.addCell("PRODUCT NAME");
                 FT.addCell("PRODUCT QUANTITY");
                 FT.addCell("PRODUCT PRICE");
       
            
                for (int i = 0; i < t.getRowCount(); i++)
                {
                 String ID=t.getValueAt(i,0).toString();
                String sname=t.getValueAt(i, 1).toString();
                 String fname=t.getValueAt(i, 2).toString();
                 String st=t.getValueAt(i, 3).toString();
               ...
               FT.addCell(sname );
                ...
                Logger.getLogger(Sellp.class.getName()).log(Level.SEVERE, null, ex);
